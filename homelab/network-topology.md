...
| virbr0 | Virtual Bridge | libvirt NAT bridge for QEMU/KVM VMs on ThinkPad |
...
- NAT bridge managed by libvirt on ThinkPad
...
|---|---|---|
| ThinkPad E16 Gen 2 | Main LAN | QEMU/KVM host, Mullvad app |
...
| Kali Linux 2026.1 VM | virbr0 (NAT) | QEMU/KVM on ThinkPad |
| REMnux VM | virbr0 (NAT) | QEMU/KVM on ThinkPad |
...
| Machine | VPN | Method |
|---|---|---|
| ThinkPad E16 | Mullvad | Mullvad app |
